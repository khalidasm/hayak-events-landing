...
const FeatureCarousel = ({ locale = 'en' }: FeatureCarouselProps) => {
  ...
  return (
    <div id="features" className="h-[200px] xl:h-[375px] bg-[url('/section2.svg')] bg-cover bg-center py-24 xl:py-48 flex flex-col items-center justify-center px-4 xl:px-60">
